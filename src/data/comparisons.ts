...
export const comparisons: Comparison[] = [
    ...
    faqs: [
      {
        ...
        answer:
          "For procedures over $2,000, CosmodiLoans typically offers better value through competitive loan rates and flexible terms. Afterpay is better suited to smaller treatments under $2,000 that you can repay quickly.",
      },
      {
        question: "Can I use Afterpay for dental implants?",
        answer:
          "Afterpay's standard limit of ~$2,000 makes it unsuitable for most dental implant procedures, which cost $3,000-$50,000. A broker-matched loan through CosmodiLoans is a better fit.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Some patients use Afterpay for minor follow-up treatments and a CosmodiLoans-matched loan for the main procedure.",
      },
      {
        question: "Which has a faster approval process?",
        answer:
          "Afterpay offers instant approval for small amounts. CosmodiLoans provides same-day decisions for larger loans, with funds typically available within 1-3 business days.",
      },
      {
        question: "What's the maximum I can borrow with each?",
        answer:
          "Afterpay: typically $2,000 (up to $4,000 for long-term users). CosmodiLoans: $2,000 to $100,000 depending on your financial situation.",
      },
    ],
  ...
  },
  {
    ...
    verdict:
      "Zip Pay offers a reusable credit line of up to $1,000 (Zip Pay) or $5,000 (Zip Plus) with interest-free periods on smaller balances. CosmodiLoans provides one-off medical loans from $2,000 to $100,000 at personalised rates via 20+ lenders. For medical procedures over $5,000, CosmodiLoans will almost always deliver a lower total cost. Zip Pay is convenient for repeat smaller purchases within its credit limit.",
    features: [
    ...
    faqs: [
      {
        question: "Is CosmodiLoans cheaper than Zip Pay for medical financing?",
        answer:
          "For procedures over $5,000, CosmodiLoans typically offers lower total cost because you receive a personalised rate from competing lenders. Zip Plus charges up to 25.9% p.a. plus a $9.95/month fee, which adds up on larger balances.",
      },
      {
        question: "Can I use Zip Pay for cosmetic surgery?",
        answer:
          "Zip Pay's $1,000 limit is too low for most cosmetic surgery. Zip Plus extends to $5,000, but most procedures exceed that. CosmodiLoans covers procedures up to $100,000.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Zip performs a credit check during sign-up which may appear on your credit file. CosmodiLoans uses an initial soft pull that does not affect your credit score.",
      },
      {
        question: "Which is better for dental loans — Zip Pay or CosmodiLoans?",
        answer:
          "For dental work costing more than $1,000, CosmodiLoans is typically the better choice. A single dental implant costs $3,000-$6,000, well beyond Zip Pay's interest-free limit.",
      },
      {
        question: "How quickly can I access funds with each option?",
        answer:
          "Zip Pay offers instant spending at participating merchants once approved. CosmodiLoans provides same-day loan decisions with funds available within 1-3 business days.",
      },
    ],
    lastReviewed: "2026-03-01",
  ...
  },
  {
    ...
    verdict:
      "Humm (formerly Certegy Ezi-Pay) offers interest-free payment plans up to $30,000 through participating providers, making it a strong option for medium-sized procedures at partnered clinics. CosmodiLoans compares 20+ lenders and covers any procedure up to $100,000 with no requirement for provider partnerships. Humm is a solid choice when your provider participates and the treatment is under $30,000. CosmodiLoans is better for larger procedures, patients who want rate comparison, or when your provider isn't a Humm partner.",
    features: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "You can use Humm for IVF only if your fertility clinic is a Humm partner and the treatment is under $30,000. Many IVF clinics are not Humm partners, and multi-cycle IVF often exceeds $30,000. CosmodiLoans covers all fertility clinics up to $100,000.",
      },
      {
        question: "Does Humm affect my credit score?",
        answer:
          "Yes, Humm Big Things performs a full credit check which appears on your credit file. CosmodiLoans uses an initial soft pull that does not impact your credit score.",
      },
      {
        question: "What happens if my provider doesn't accept Humm?",
        answer:
          "If your provider isn't a Humm partner, you cannot use Humm for that treatment. CosmodiLoans works with any medical provider because the loan funds are paid directly to you or your provider upon settlement.",
      },
      {
        question: "Can I get more than $30,000 through Humm?",
        answer:
          "No, Humm's maximum is $30,000 through Humm Big Things. For procedures exceeding this amount, such as extensive dental reconstruction or multiple cosmetic procedures, CosmodiLoans can arrange loans up to $100,000.",
      },
      {
        question: "Which is faster — Humm or CosmodiLoans?",
        answer:
          "Humm can be approved in-clinic in minutes for smaller amounts. CosmodiLoans provides same-day decisions, with funds typically available within 1-3 business days. For urgent procedures, both options are generally quick enough.",
      },
    ],
    lastReviewed: "2026-03-01",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    verdict:
      "CareCredit is a well-known medical credit card in the US market, but its availability in Australia is limited compared to local options. CosmodiLoans connects you with 20+ Australian lenders who specialise in medical financing. For Australian patients, CosmodiLoans provides broader access to competitive rates and local lenders. CareCredit may suit patients already familiar with the platform from overseas or those visiting CareCredit-partnered providers.",
    features: [
    ...
    howWeWork:
      "CosmodiLoans is an Australian medical finance broker. Your dedicated broker compares offers from 20+ local lenders to find the most competitive rate for your specific procedure. The initial assessment uses a soft credit pull, the service is free, and funds can be used at any medical provider in Australia.",
    howTheyWork:
    ...
    faqs: [
      {
        ...
        answer:
          "CareCredit has a limited presence in Australia compared to the US. Many Australian medical providers are not enrolled. CosmodiLoans connects you with 20+ local lenders, providing broader access to competitive medical financing.",
      },
      {
        question: "What is CareCredit's deferred interest?",
        answer:
          "If you don't pay off your CareCredit balance within the promotional period, interest is charged retroactively from the original purchase date at rates up to 26.99% p.a. CosmodiLoans offers fixed-rate loans with no deferred interest risk.",
      },
      {
        question: "Which has lower interest rates for medical procedures?",
        answer:
          "CareCredit offers 0% during promotional periods but jumps to 26.99% if unpaid. CosmodiLoans offers personalised rates from 6.99% p.a. across 20+ lenders. For longer-term financing, CosmodiLoans typically delivers a lower total cost.",
      },
      {
        question: "Can I use CareCredit for cosmetic surgery in Australia?",
        answer:
          "Only at CareCredit-enrolled providers, which are limited in Australia. CosmodiLoans funds can be used at any cosmetic surgeon or clinic nationwide.",
      },
      {
        question: "Does CareCredit require a credit check?",
        answer:
          "Yes, CareCredit performs a credit check during the application. CosmodiLoans uses a soft pull for the initial assessment, so your credit score is not affected until you choose to proceed with a specific lender.",
      },
      {
        question: "Which is better for dental financing in Australia?",
        answer:
          "For Australian dental patients, CosmodiLoans generally offers better access because it works with any dentist. CareCredit is limited to enrolled dental practices, and its standard interest rate of 26.99% is significantly higher than most broker-matched rates.",
      },
    ],
    lastReviewed: "2026-03-01",
  ...
  },
  {
    ...
    verdict:
      "Latitude Financial (formerly GE Finance) is one of Australia's larger personal loan providers, offering fixed-rate loans and the Latitude Gem Visa with interest-free promotions. CosmodiLoans compares Latitude alongside 20+ other lenders to find your best rate. Going directly to Latitude means accepting their single offer, while CosmodiLoans may find a better rate from Latitude or a competing lender. Latitude is a reputable direct option, but comparing through a broker costs nothing extra and often secures a lower rate.",
    features: [
    ...
    faqs: [
      {
        question: "Can CosmodiLoans get me a Latitude loan?",
        answer:
          "CosmodiLoans compares rates from 20+ lenders. While we don't guarantee access to every lender's products, our panel includes major Australian lenders. If Latitude offers the best rate for your situation, your broker will recommend it.",
      },
      {
        question: "Is Latitude Financial good for medical loans?",
        answer:
          "Latitude offers competitive personal loans that can be used for medical procedures. However, their rates start from 8.99% p.a., while a broker comparison through CosmodiLoans can access rates from 6.99% p.a. across 20+ lenders.",
      },
      {
        question: "Does Latitude charge an establishment fee?",
        answer:
          "Yes, Latitude charges a $299 establishment fee on personal loans. CosmodiLoans-matched loans have varying establishment fees ($0-$450 depending on the lender), and your broker will factor all fees into the comparison.",
      },
      {
        question: "How long does Latitude take to approve a loan?",
        answer:
          "Latitude typically provides a decision within 1-2 business days for personal loans. CosmodiLoans also provides same-day decisions, with the added benefit of comparing multiple offers simultaneously.",
      },
      {
        question: "What credit score do I need for Latitude?",
        answer:
          "Latitude generally requires a good credit score (600+). CosmodiLoans works with lenders across the credit spectrum, so even if Latitude declines you, your broker can find alternative lenders suited to your profile.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      {
        question: "Is MoneyMe cheaper than CosmodiLoans for medical loans?",
        answer:
          "MoneyMe's rates start from 8.49% p.a. but are risk-based, so many borrowers receive higher rates. CosmodiLoans compares 20+ lenders with rates from 6.99% p.a., often finding a lower overall rate than MoneyMe's direct offer.",
      },
      {
        question: "How fast is MoneyMe compared to CosmodiLoans?",
        answer:
          "MoneyMe can approve and fund loans within minutes to hours. CosmodiLoans provides same-day decisions with funds typically available in 1-3 business days. MoneyMe is faster, but the trade-off may be a higher rate.",
      },
      {
        question: "Does MoneyMe charge establishment fees?",
        answer:
          "No, MoneyMe charges $0 establishment fees and $0 early exit fees. Some lenders on the CosmodiLoans panel also offer $0 fees, and your broker will factor all fees into the total cost comparison.",
      },
      {
        question: "Can I use MoneyMe for cosmetic surgery?",
        answer:
          "Yes, MoneyMe personal loans can be used for any purpose including cosmetic surgery. However, their maximum of $50,000 may not cover extensive procedures. CosmodiLoans covers up to $100,000.",
      },
      {
        question: "What credit score does MoneyMe require?",
        answer:
          "MoneyMe uses risk-based pricing, so they accept a range of credit scores but charge higher rates for lower scores. CosmodiLoans works with specialist lenders who cater to various credit profiles, potentially finding better rates for imperfect credit.",
      },
      {
        question: "Should I apply to MoneyMe and CosmodiLoans?",
        answer:
          "We recommend starting with CosmodiLoans since your broker compares 20+ lenders (which may include similar offers). If you need funds immediately and can't wait, MoneyMe's speed is its key advantage.",
      },
    ],
    lastReviewed: "2026-03-01",
  ...
  },
  {
    ...
    verdict:
      "Plenti (formerly RateSetter) is a peer-to-peer lending platform offering competitive personal loan rates in Australia. Their rates are among the lowest in the direct lender market, starting from around 7.99% p.a. CosmodiLoans compares Plenti alongside 20+ other lenders and can often match or beat their rate. Plenti is a strong direct option for borrowers with excellent credit. CosmodiLoans is better for rate comparison, higher loan amounts, and patients who want broker support.",
    features: [
    ...
    howWeWork:
      "CosmodiLoans matches you with a personal broker who compares rates from over 20 lenders across Australia. Your broker finds the best rate for your procedure and manages the entire application process. The service is free, and the initial credit check is a soft pull with no impact on your score.",
    howTheyWork:
    ...
    faqs: [
      {
        question: "Are Plenti's rates lower than CosmodiLoans?",
        answer:
          "Plenti's advertised rates start from 7.99% p.a. for borrowers with excellent credit. CosmodiLoans accesses rates from 6.99% p.a. across 20+ lenders. Your broker will compare Plenti-equivalent offers to find the lowest available rate.",
      },
      {
        question: "What is Plenti's establishment fee?",
        answer:
          "Plenti charges a $399 establishment fee on personal loans. Some lenders on the CosmodiLoans panel charge $0 establishment fees, which your broker will factor into the total cost comparison.",
      },
      {
        question: "Is Plenti safe for medical financing?",
        answer:
          "Yes, Plenti holds an Australian Credit Licence and is a regulated lender. Their peer-to-peer model is well-established. Both Plenti and CosmodiLoans panel lenders are regulated by ASIC.",
      },
      {
        question: "Can I get a Plenti loan through CosmodiLoans?",
        answer:
          "CosmodiLoans works with a panel of 20+ lenders. While Plenti may not be directly on our panel, we access lenders offering similar or better rates. Your broker will find the most competitive option regardless.",
      },
      {
        question: "How long does Plenti take to fund a loan?",
        answer:
          "Plenti typically funds within 1-3 business days of approval. CosmodiLoans offers a similar timeline, with the added benefit of comparing multiple lenders before you commit.",
      },
      {
        question: "Which is better for IVF financing — Plenti or CosmodiLoans?",
        answer:
          "Both can fund IVF. Plenti's maximum is $50,000, which covers most IVF journeys. CosmodiLoans covers up to $100,000 and may find a lower rate through broker comparison. For multi-cycle IVF, CosmodiLoans provides more headroom.",
      },
    ],
    lastReviewed: "2026-03-01",
  ...
  },
  {
    ...
    verdict:
      "SocietyOne is an Australian peer-to-peer lender offering personal loans with competitive rates for borrowers with good credit. CosmodiLoans compares SocietyOne-equivalent offers from 20+ lenders to ensure you're getting the best rate. SocietyOne is a solid direct option with a smooth digital process. CosmodiLoans is the better choice if you want rate comparison, broker support, or need a loan above $50,000.",
    features: [
      { feature: "Maximum Amount", us: "$2,000 – $100,000", them: "$5,000 – $50,000" },
    ...
    faqs: [
      {
        ...
        answer:
          "SocietyOne offers personal loans that can be used for medical procedures. Their rates are competitive for good-credit borrowers. However, they only offer their own product, while CosmodiLoans compares 20+ lenders to find the best fit.",
      },
      {
        question: "What rates does SocietyOne offer?",
        answer:
          "SocietyOne's rates start from 7.49% p.a. but are risk-based, so your actual rate depends on your credit profile. CosmodiLoans accesses rates from 6.99% p.a. across 20+ lenders, which may result in a lower rate for your situation.",
      },
      {
        question: "Does SocietyOne charge an establishment fee?",
        answer:
          "Yes, SocietyOne charges an establishment fee of $199-$499 depending on your credit profile and loan amount. Some CosmodiLoans panel lenders offer $0 establishment fees.",
      },
      {
        question: "How long does SocietyOne take to approve a loan?",
        answer:
          "SocietyOne typically provides a decision within 1-2 business days. CosmodiLoans also offers same-day decisions, with the advantage of comparing multiple offers in parallel.",
      },
      {
        question: "Can I use SocietyOne for cosmetic surgery financing?",
        answer:
          "Yes, SocietyOne personal loans can fund cosmetic surgery up to $50,000. For procedures exceeding this amount, CosmodiLoans covers up to $100,000 through its lender panel.",
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    howWeWork:
      "A medical loan through CosmodiLoans is a personal loan arranged by a specialist broker. Your broker compares rates from 20+ lenders, understands typical procedure costs and clinic payment requirements, and manages the entire application process. The initial assessment uses a soft credit pull and the service is free.",
    howTheyWork:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Medical loans accessed through a broker often have lower rates because the broker compares multiple lenders. CosmodiLoans accesses rates from 6.99% p.a., compared to typical bank personal loan rates of 8-15% p.a.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Through CosmodiLoans, you can borrow $2,000 to $100,000 for medical procedures. Standard bank personal loans typically cap at $50,000, though some go higher.",
      },
      {
        question: "Will a medical loan affect my credit score?",
        answer:
          "CosmodiLoans uses a soft pull for the initial assessment (no credit impact). A hard credit check only occurs when you proceed with a specific lender. The same applies to most bank personal loan applications, though some banks do a hard pull upfront.",
      },
    ],
    lastReviewed: "2026-03-01",
  ...
  },
  {
    ...
    howWeWork:
      "A medical loan through CosmodiLoans gives you a fixed-rate personal loan with a set repayment schedule. Your broker compares 20+ lenders to find the lowest rate for your procedure. You know exactly what you'll pay each month and when the loan will be fully repaid. There are no surprises.",
    howTheyWork:
  ...
  },
  {
    ...
    howWeWork:
      "A medical loan through CosmodiLoans is a personal loan arranged by a specialist healthcare finance broker. Your broker compares rates from 20+ lenders, finds the lowest rate for your procedure, and manages the application. The loan provides a lump sum at a fixed rate with structured monthly repayments and a clear end date.",
    howTheyWork:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "BNPL providers are increasingly reporting to credit bureaus in Australia. Missed payments can negatively affect your credit score. CosmodiLoans uses a soft pull for initial assessments with no credit impact.",
      },
      {
