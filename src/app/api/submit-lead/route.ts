      ...
      await resend.emails.send({
        ...
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px">
          ...
          <table style="width:100%;border-collapse:collapse">
            <tr><td style="padding:8px 0;color:#64748b;width:120px">Source</td><td style="padding:8px 0;font-weight:600">${source || "Not provided"}</td></tr>
            ...
            <tr style="background:#f8fafc"><td style="padding:8px;color:#64748b">Phone</td><td style="padding:8px;font-weight:600">${phone || "Not provided"}</td></tr>
            <tr><td style="padding:8px 0;color:#64748b">Procedure</td><td style="padding:8px 0;font-weight:600">${procedure || "Not provided"}</td></tr>
            <tr style="background:#f8fafc"><td style="padding:8px;color:#64748b">Amount</td><td style="padding:8px;font-weight:600">${amount || "Not provided"}</td></tr>
