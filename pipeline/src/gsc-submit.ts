...
const TOP_PAGES = [
  ...
  "/guides/all-on-4-dental-implants-payment-plans-australia",
  "/guides/medical-loans-for-surgery-australia",
  "/guides/cosmetic-surgery-loans-australia",
  "/guides/dental-surgery-loans-australia",
  "/guides/vet-bill-loans-australia",
  "/guides/dental-implants-cost-australia",
  "/guides/all-on-4-dental-implants-cost-australia",
  "/guides/ivf-cost-australia",
  "/guides/breast-augmentation-cost-australia",
  "/guides/breast-augmentation-payment-plans-australia",
  "/guides/vetpay-alternatives-australia",
  "/guides/fat-transfer-breast-augmentation-cost-australia",
  "/guides/topics/dental-finance",
  "/guides/topics/ivf-finance",
  "/guides/topics/cosmetic-surgery-finance",
  "/guides/topics/vet-bill-finance",
